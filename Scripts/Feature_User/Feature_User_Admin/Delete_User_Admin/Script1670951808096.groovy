...
response = WS.sendRequest(findTestObject('API/User/User_Admin/TC_Delete_User_01'))

WS.verifyResponseStatusCode(response, GlobalVariable.status_code)

response = WS.sendRequest(findTestObject('API/User/User_Admin/TC_Delete_User_02'))
